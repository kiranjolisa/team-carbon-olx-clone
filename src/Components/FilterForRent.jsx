...
function FilterForRent(){
    ...
    const[allowedFlag, setAllowedFlag] = useState(false);

    return (
        <div style={{textAlign: "left", padding: "2% 5%", boxSizing: "border-box"}}>
            <div style={{fontSize: "24px", fontWeight: "bold"}}>Houses & Apartments For Rent</div>
            <div>
...

            {
                ...
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", paddingLeft: "2px", color: "#002f34", padding: "2% 5%"}}>Below 5000</div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", paddingLeft: "2px", color: "#002f34", padding: "2% 5%"}}>5000 - 10000</div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", paddingLeft: "2px", color: "#002f34", padding: "2% 5%"}}>10000 - 15000</div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", paddingLeft: "2px", color: "#002f34", padding: "2% 5%"}}>15000 - 25000</div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", paddingLeft: "2px", color: "#002f34", padding: "2% 5%"}}>25000 - 50000</div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", paddingLeft: "2px", color: "#002f34", padding: "2% 5%"}}>50000 - 100000</div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", paddingLeft: "2px", color: "#002f34", padding: "2% 5%"}}>100000 and Above</div>
            </div>
            }
            <br />
            <hr />
            ...
            <div style={{display: "flex", alignItems: "center"}}>
                ...
                <div style={{flexGrow: "1"}}></div>
                {!allowedFlag ? <DownOutlined onClick={()=>setAllowedFlag(!allowedFlag)} /> : <UpOutlined onClick={()=>setAllowedFlag(!allowedFlag)} />}
            </div>

            {
                allowedFlag && <div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", padding: "2% 5%", color: "#002f34"}}>Bachelors allowed</div>
                <div style={{border: "1px solid black", width: "90%", marginTop: "5px", padding: "2% 5%", color: "#002f34"}}>Bachelors not allowed</div>
            </div>
            }
            <br />
            <hr />
