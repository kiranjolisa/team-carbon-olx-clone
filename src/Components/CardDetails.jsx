...
function CardDetails({image, brand, year, model, distance, price, address, date, description, sellerName}){
    return (
        <div className={styles.container}>
            <div className={styles.subContainer}>
                ...
                <div style={{textAlign: "left", border: "1px solid rgba(0,47,52,.64)"}}>
                    ...
                    <div className={styles.spanCont}>
                        <span style={{color: "rgba(0,47,52,.64)"}}>Brand</span><span>{brand}</span>
                        <span style={{color: "rgba(0,47,52,.64)"}}>Model</span><span>{model}</span>
                        <span style={{color: "rgba(0,47,52,.64)"}}>Year</span>
                        <span>{year}</span>
                        <span style={{color: "rgba(0,47,52,.64)"}}>KM driven</span><span>{distance}</span>
                    </div>
                    <hr />
            ...
            <div className={styles.subContainer}>
                ...
                <div style={{border: "1px solid rgba(0,47,52,.64)"}} className={styles.bold}>
                    Seller Description
                    <div style={{textAlign: "left"}}>{sellerName}</div>
